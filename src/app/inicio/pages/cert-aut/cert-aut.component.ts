...
@Component({
  selector: 'app-cert-aut',
  templateUrl: './cert-aut.component.html',
  styleUrls: ['./cert-aut.component.css']
})
export class CertAutComponent implements OnInit {
  ...
  public title : string = "Certificación Automática";
  ...
  public valuelabel : string = "Fecha: "
  public fechailabel : string = "10/10/2021"
  public fechaflabel : string = "12/10/2021"
